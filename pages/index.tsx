...
export default function Home() {
  ...
  const [walletBalance, setWalltetBalance] = useState<number>(0);

  useEffect(() => {
    if (account) {
      setWalltetBalance(balance);
    }
  }, [balance]);
  ...
  return (
    <div className="flex flex-col min-h-screen justify-start bg-gradient-to-b from-gray-800  to-gray-500">
      <Head>
        <title>P2P Payment dApp Polygon</title>
          ...
          <div className="flex flex-col items-center space-y-2">
            <div className="w-full flex flex-row justify-between">
              ...
              <span className="text-white text-base text-start font-bold font-inconsolata">
                {balance && `Balance: ${walletBalance.toString()} PAY`}
              </span>
            </div>
            ...
            <div
              ...
              onClick={async () => {
                ...
                if (!account) {
                  ...
                  setButton("Sending...");
                  let msg = await sendPayment({ amount, toAddress });
